\chapter{Introduction}
  \section{The Inequalities of Interactivity}
    ...
    hands-free interaction, speed, virtuosity, and control. \red{This is the
    main reason why we see experts use dedicated physical interfaces in high
    stake situations instead of their screen-based counterparts.}
    ...
    experiences}.  In 60 years, we have gone from programming computers using
    ...
    \red{reasons}, and remains out of the reach of other domain experts (e.g.,
