\chapter{AirLogic} \label{ch:airlogic}
  ...
  these techniques still require a computing device to process and identify the
  provided input, and to drive the output.  This limitation inspired me to think
  about the construction of tangible devices where \emph{everything} is
  encapsulated in the device: input sensing, logic processing, and output
  display. This upcoming chapter is the result of this exploration.
  ...
  \section{Related Work}
    ...
    fabrication of interactive objects, fluidics, and analog computing. I have
    previously presented an overview of the fabrication of tangible devices
    literature (Chapter \ref{ch:background}), thus this section describes the
    current state of the fluidics, analog computing, and toolkit research.
  ...
  \section{Validation}
    ...
    \subsection{Example Applications}
      ...
      use of any electronics. These applications were not constructed, but their
      behavior was simulated using fluid dynamics simulation
      software~\cite{CFD:}.
